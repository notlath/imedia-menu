...
const LAYOUT_OPTIONS = [
    { label: __('Standard Columns (legacy)', 'imedia-menu'), value: 'columns' },
    { label: __('Grid (12-track)', 'imedia-menu'), value: 'grid' },
    { label: __('Flyout (use WordPress submenu)', 'imedia-menu'), value: 'flyout' },
];
    ...
    return (
        <div className="imm-panel-settings-drawer">
            ...
            <div className="imm-drawer-body">
                ...
                <SelectControl
                    label={__('Layout Type', 'imedia-menu')}
                    help={__('Standard: legacy column layout. Grid: 12-track CSS grid with per-column span. Flyout: skip panel, use WordPress submenu.', 'imedia-menu')}
                    value={config.layout_type || 'columns'}
                    options={LAYOUT_OPTIONS}
                    onChange={(value) =>
                        dispatch.updatePanelConfig({ layout_type: value })
                    }
                />
