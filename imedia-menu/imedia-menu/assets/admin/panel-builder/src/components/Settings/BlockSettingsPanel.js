...
import RealWidgetSettings from './fields/RealWidgetSettings';
import ReplacementsSettings from './fields/ReplacementsSettings';
import TabbedSettings from './fields/TabbedSettings';
import AccordionSettings from './fields/AccordionSettings';
import LoginStateSettings from './fields/LoginStateSettings';
import CartSettings from './fields/CartSettings';
import DynamicHtmlSettings from './fields/DynamicHtmlSettings';
...
const SETTINGS_MAP = {
    ...
    real_widget: RealWidgetSettings,
    replacements: ReplacementsSettings,
    tabbed: TabbedSettings,
    accordion: AccordionSettings,
    login_state: LoginStateSettings,
    cart: CartSettings,
    dynamic_html: DynamicHtmlSettings,
};
