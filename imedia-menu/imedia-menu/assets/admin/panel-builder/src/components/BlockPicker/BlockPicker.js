    ...
    return (
        <div className="imm-block-picker-overlay">
            <div className="imm-block-picker">
                ...
                {isFlyout ? (
                    <div className="imm-block-picker-flyout-notice">
                        <p>
                            {__('Flyout layout uses the WordPress submenu directly. Manage menu items in ', 'imedia-menu')}
                            <a
                                href="nav-menus.php"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                                {__('Appearance → Menus', 'imedia-menu')}
                            </a>
                            {__('.', 'imedia-menu')}
                        </p>
                    </div>
