...
final class AdvancedTab implements SettingsTab {
	...
	public function render( array $settings ): void {
		...
		<table class="form-table">
			...
			<tr>
				<th scope="row"><?php esc_html_e( 'Import from Megamenu', 'imedia-menu' ); ?></th>
				<td>
					<button type="button"
							class="button imedia-megamenu-import-btn">
						<?php esc_html_e( 'Import Megamenu Data', 'imedia-menu' ); ?>
					</button>
					<p class="description">
						<?php esc_html_e( 'Requires the Megamenu plugin to be active on this site. Reads and converts settings, menu meta, and toggle blocks.', 'imedia-menu' ); ?>
					</p>
				</td>
			</tr>
		</table>
