...
if (version_compare(PHP_VERSION, MIN_PHP, '<')) {
    add_action('admin_notices', function (): void {
        $message = sprintf(
            __('iMedia Menu requires PHP %s or higher. Your site is running PHP %s.', 'imedia-menu'),
            MIN_PHP,
            PHP_VERSION
        );
...
register_activation_hook(FILE, [Activator::class, 'activate']);
register_deactivation_hook(FILE, [Deactivator::class, 'deactivate']);
