...
final class PanelRepository
{
    ...
    public function save(int $menuItemId, int $menuId, array $data): bool
    {
        ...
        if ($existing) {
            return $wpdb->update($this->table, $fields, ['id' => $existing->id]) !== false;
        }
    ...
    public function delete(int $menuItemId): bool
    {
        ...
        return $wpdb->delete($this->table, ['menu_item_id' => $menuItemId]) !== false;
    }
    ...
    public function deleteByMenu(int $menuId): bool
    {
        ...
        return $wpdb->delete($this->table, ['menu_id' => $menuId]) !== false;
    }
